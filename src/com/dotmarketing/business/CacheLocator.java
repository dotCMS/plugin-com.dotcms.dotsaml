...
import com.dotcms.plugin.saml.v4.cache.SamlCache;
import com.dotcms.plugin.saml.v4.cache.SamlCacheImpl;
...
/**
 * FactoryLocator is a factory method to get single(ton) service objects. This
 * is a kind of implementation, and there may be others.
 * 
...
public class CacheLocator extends Locator<CacheIndex>
{
	...
	public synchronized static void init()
	{
		...
		/*
		 * Initializing the Cache Providers: It needs to be initialized in a
		 * different call as the providers depend on the license level, and the
		 * license level needs an already created instance of the CacheLocator
		 * to work.
		 */
	...
	/**
	 * The legacy cache administrator will invalidate cache entries within a
	 * cluster on a put where the non legacy one will not.
	 * 
	 * @return
	 */
...
enum CacheIndex
{
	...
	Cachable create()
	{
		switch ( this )
		{
			...
			case Saml: return new SamlCacheImpl(); // SAML PLUGIN CHANGE
