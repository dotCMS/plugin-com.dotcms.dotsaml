...
class DomXMLWebDescriptorImpl implements WebDescriptor {
    ...
    public boolean existsElement(final String elementTag, final String subElementTag, final String elementValue) {
        ...
        final NodeList nodeList  =
                this.document.getElementsByTagName(elementTag);
    ...
    public void addFilterBefore(final String filterName, final FilterConfigBean filter) {
        ...
        final Element filterMappingElement =
                this.createFilterMappingElement(filter);
    ...
    public void removeFilter(String filterClassName) {
        ...
        final Element filterElement =
                this.findElement ("filter", "filter-class", filterClassName);
        Node parentNode;
    ...
    protected Element findElement(final String elementNameToFind,
                                  final String subElementNameToFind,
        ...
        String  subElementValue  = null;
        final NodeList nodeList  =
                this.document.getElementsByTagName(elementNameToFind);
    ...
    /**
     * Adds an element "newElement" before the element with the name: "beforeElementName"
     *
     * The element name to find is "elementNameToFind", for instance if you want to add a filter before another one,
     * you have to set it as "filter"
     *
     * The sub element name to get the text to compare to "beforeFilterName" is "subElementNameToFind", for instance for a
     * filter it will be "filter-name".
     *
     * @param beforeElementName {@link String}
     * @param newElement {@link Element}
     * @param elementNameToFind  {@link String}
     * @param subElementNameToFind  {@link String}
     */
    protected void addElementBefore(final String  beforeElementName,
                                    final Element newElement,
                                    final String  elementNameToFind,
                                    final String  subElementNameToFind) {
    ...
    protected String getChildText(final Element currentElement,
                                  final String tagName) {

        String text = null;
        final NodeList nodeList =
                currentElement.getElementsByTagName(tagName);
    ...
    protected Element createFilterElement (final FilterConfigBean filter) {
        ...
        filterNameElement.appendChild
                (this.document.createTextNode(filter.getFilterClass().getSimpleName()));
        filterClassElement.appendChild
                (this.document.createTextNode(filter.getFilterClass().getName()));
    ...
    protected Element createFilterMappingElement (final FilterConfigBean filter) {
        ...
        filterMappingNameElement.appendChild
                (this.document.createTextNode(filter.getFilterClass().getSimpleName()));
        filterMappingUrlPatternElement.appendChild
                (this.document.createTextNode(filter.getUrlPattern()));
