...
import com.dotcms.plugin.saml.v4.CredentialProvider;
import com.dotcms.plugin.saml.v4.DotSamlConstants;
import com.dotcms.plugin.saml.v4.InstanceUtil;
import com.dotcms.plugin.saml.v4.SamlUtils;
import com.dotcms.plugin.saml.v4.exception.InvalidIssuerValueException;
...
public class IdpConfig implements OptionalPropertiesHelper, MetaDataHelper, EndpointHelper
{
	...
	public String getAssertionConsumerEndpoint()
	{
		...
		spIssuerValue += DotSamlConstants.ASSERTION_CONSUMER_ENDPOINT_DOTSAML4SP;
	...
	public String getSingleLogoutEndpoint()
	{
		...
		spIssuerValue += DotSamlConstants.LOGOUT_SERVICE_ENDPOINT_DOTSAML4SP;
