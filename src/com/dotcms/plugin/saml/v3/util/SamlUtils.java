...
public class SamlUtils
{
	...
	public static LogoutRequest buildLogoutRequest( final IdpConfig idpConfig, final NameID nameID, final String sessionIndexValue )
	{
		...
		if ( !isSet( idpSingleLogoutDestionation ) )
		{
			...
			throw new DotSamlException( "The property: " + DOTCMS_SAML_IDENTITY_PROVIDER_DESTINATION_SLO_URL + " must be set on the host" );
		}
	...
	public static AuthnRequest buildAuthnRequest( final HttpServletRequest request, final IdpConfig idpConfig )
	{
		...
		if ( !isSet( ipDSSODestination ) )
		{
			...
			throw new DotSamlException( "The property: " + DOTCMS_SAML_IDENTITY_PROVIDER_DESTINATION_SSO_URL + " must be set on the host" );
		}
