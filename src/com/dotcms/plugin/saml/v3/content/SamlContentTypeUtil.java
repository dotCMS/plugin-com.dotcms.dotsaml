...
public class SamlContentTypeUtil {
    ...
    @VisibleForTesting
    public SamlContentTypeUtil(final StructureAPI structureAPI,
    ...
    public void checkORCreateSAMLField() {
        ...
        try {
            ...
            hostStructure =
                    this.structureAPI.findByVarName(HOST_VARIABLE_NAME, this.userAPI.getSystemUser());
    ...
    private Field createSamlConfigField(final Structure hostStructure) {
        ...
        return new Field(DotSamlConstants.DOTCMS_SAML_CONTENT_TYPE_FIELD_CONFIG_NAME,
    ...
    private boolean hasSAMLFields(final Structure hostStructure) {
        ...
        final List<Field> fieldsByHost =
                FieldsCache.getFieldsByStructureInode(hostStructure.getInode());
