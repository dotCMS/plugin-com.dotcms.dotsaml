...
public interface AssertionResolverHandler extends Serializable {
    ...
    /**
     * Resolve the user based on a SAML callback, depending on the implementation the criteria to check if it is a saml request
     * and how to handle might be different.
     *
     * @param request   {@link HttpServletRequest}
     * @param response  {@link HttpServletResponse}
     * @param siteName  {@link String}
...
} // E:O:F:AssertionResolverHandler.
