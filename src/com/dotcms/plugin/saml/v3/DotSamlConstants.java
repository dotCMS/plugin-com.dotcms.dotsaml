...
public final class DotSamlConstants {
    ...
    /**
     * Key for site-config.json to get the Saml protocol binding, by default use {@link org.opensaml.saml.common.xml.SAMLConstants}.SAML2_ARTIFACT_BINDING_URI
     */
    ...
    /**
     * Optional Key for  site-config.json
    ...
    /**
     * Key for dotmarketing-config.properties
     * This is the path to resolve the sites-config.json with the configuration per site.
     */
    public  static final String  DOTCMS_SAML_SITES_CONFIG_PATH = "dotcms.saml.sites.config.path";
