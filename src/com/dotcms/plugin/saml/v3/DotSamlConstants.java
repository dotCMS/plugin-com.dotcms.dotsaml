...
public final class DotSamlConstants {
    ...
    /**
     * Key for host field configuration (see {@link org.opensaml.saml.common.xml.SAMLConstants}.DOTCMS_SAML_FIELD_NAME)
     * Used to get the Saml protocol binding, by default use {@link org.opensaml.saml.common.xml.SAMLConstants}.SAML2_ARTIFACT_BINDING_URI
     */
    ...
    /**
     * Optional Key for host field configuration (see {@link org.opensaml.saml.common.xml.SAMLConstants}.DOTCMS_SAML_FIELD_NAME)
