...
<div class="portlet-main">
    ...
    <div class="yui-g portlet-toolbar">
        <div class="yui-u first">
            <input type="text" name="filter" id="filter" dojoType="dijit.form.TextBox" class="large" value="" intermediateChanges="true" onChange="idpAdmin.searchIdpByName();"/>
            <button dojoType="dijit.form.Button" onclick="idpAdmin.resetSearch();" iconClass="resetIcon">
...
<div id="addEditIdPDialog" dojoType="dijit.Dialog" disableCloseButton="true" title="<%=LanguageUtil.get(pageContext, "add-edit-dialog-title")%>" style="display: none; width:600px">
    <div>
        <form id="addEditIdPForm" name="addEditIdPForm" dojoType="dijit.form.Form">
            <div class="form-inline" style="padding:0 0 10px 0; border-bottom:1px solid #ccc;">
                <dl>
                ...
                <dl>
                    <dt><span class="required"></span><label for="idpName"><%=LanguageUtil.get(pageContext, "idp-config-name-label")%></label></dt>
                ...
                <dl>
                    <dt><span class="required"></span><label for="sPIssuerURL"><%=LanguageUtil.get(pageContext, "sp-issuer-url-label")%></label></dt>
                    <dd><input type="text" name="sPIssuerURL" id="sPIssuerURL" required="true" onkeydown="" dojoType="dijit.form.TextBox" value="" /></dd>
                </dl>

                <dl>
                    <dt><span class="required"></span><label for="sPEndponintHostname"><%=LanguageUtil.get(pageContext, "sp-endpoint-hostname-label")%></label></dt>
                ...
                <dl>
                    <dt><span class="required"></span><label for="privateKey"><%=LanguageUtil.get(pageContext, "private-key-label")%></label></dt>
                    <dd><div id="privateKeySavedFile" id="privateKeySavedFile"></div><input type="file" id="privateKey" name="privateKey" required="true"></dd>
                </dl>

                <dl>
                    <dt><span class="required"></span><label for="publicCert"><%=LanguageUtil.get(pageContext, "public-certificate-label")%></label></dt>
                    <dd><div id="publicCertSavedFile" id="publicCertSavedFile"></div><input type="file" id="publicCert" name="publicCert" required="true"></dd>
                </dl>

                <dl>
                    <dt><span class="required"></span><label for="idPMetadataFile"><%=LanguageUtil.get(pageContext, "idp-metadata-label")%></label></dt>
                ...
                <dl>
                    <dt><span class="required"></span><label for="signatureValidationType"><%=LanguageUtil.get(pageContext, "idp-validation-label")%></label></dt>
